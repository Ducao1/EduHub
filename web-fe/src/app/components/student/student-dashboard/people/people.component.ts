...
import { TeacherNavBarComponent } from '../../../teacher/teacher-nav-bar/teacher-nav-bar.component';
...
export class PeopleComponent {
  ...
  followStudent(student: User) {
    ...
    this.router.navigate(['/student/class', this.classId, 'student', student.id]);
    this.closeDropdown();
  }
